...
<table width="800" border="1">
  <tbody>      
	  ...
	  <td>  </td>
    <?php
	$sql=mysqli_query($conn,"select * from item where attribute='$attribute' and name='$name'");
	$info=mysqli_fetch_array($sql);
	if($info==false){
		echo "暂无商品信息";
	}else{
		$sql1=mysqli_query($conn,"select * from item where attribute='$attribute'and name='$name'");
